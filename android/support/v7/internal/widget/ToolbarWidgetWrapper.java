...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C01732 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C01743 extends ViewPropertyAnimatorListenerAdapter {
        C01743() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C01732());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C01743());
        }
    }
