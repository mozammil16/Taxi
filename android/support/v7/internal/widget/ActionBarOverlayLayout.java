...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    ...
    class C01711 extends ViewPropertyAnimatorListenerAdapter {
        C01711() {
        }
    ...
    class C01722 extends ViewPropertyAnimatorListenerAdapter {
        C01722() {
        }
    ...
    public ActionBarOverlayLayout(Context context) {
        ...
        this.mTopAnimatorListener = new C01711();
        this.mBottomAnimatorListener = new C01722();
