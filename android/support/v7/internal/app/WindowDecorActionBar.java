...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01603 implements ViewPropertyAnimatorUpdateListener {
        C01603() {
        }
    ...
    class C01681 extends ViewPropertyAnimatorListenerAdapter {
        C01681() {
        }
    ...
    class C01692 extends ViewPropertyAnimatorListenerAdapter {
        C01692() {
        }
    ...
    public WindowDecorActionBar(ActionBarActivity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C01681();
        this.mShowListener = new C01692();
        this.mUpdateListener = new C01603();
