...
public class ListPopupWindow {
    ...
    class C01651 extends ForwardingListener {
        C01651(View x0) {
            super(x0);
        }
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0132R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case C0132R.styleable.Toolbar_navigationIcon /*20*/:
                        case C0132R.styleable.Theme_actionMenuTextColor /*23*/:
                        case C0132R.styleable.Theme_listPreferredItemPaddingLeft /*66*/:
                            return true;
                    }
