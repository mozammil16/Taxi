...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements Callback {
    ...
    class C00891 implements Runnable {
        ...
        public void run() {
            ...
            if ((ActionBarActivityDelegateBase.this.mInvalidatePanelMenuFeatures & AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) != 0) {
    ...
    class C01572 implements OnApplyWindowInsetsListener {
        C01572() {
        }
    ...
    class C01583 implements OnFitSystemWindowsListener {
        C01583() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            if (this.mHasActionBar) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C01572());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C01583());
                }
            }
    ...
    public boolean supportRequestWindowFeature(int featureId) {
        switch (featureId) {
            ...
            case TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE /*8*/:
                ...
                return true;
            case C0132R.styleable.Toolbar_titleTextAppearance /*9*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mOverlayActionBar = true;
                return true;
            case C0132R.styleable.Toolbar_subtitleTextAppearance /*10*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    protected boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case C0132R.styleable.Theme_colorButtonNormal /*82*/:
    ...
    View createView(String name, @NonNull Context context, @NonNull AttributeSet attrs) {
        if (VERSION.SDK_INT < 21) {
            ...
            switch (obj) {
                ...
                case C0132R.styleable.Toolbar_contentInsetRight /*7*/:
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.f0x, st.f1y, 1002, 8519680, -3);
