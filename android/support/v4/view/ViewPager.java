...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01501 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01501() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01501());
        }
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case DEFAULT_GUTTER_SIZE /*16*/:
                            ...
                            break;
                        case C0132R.styleable.Theme_selectableItemBackgroundBorderless /*48*/:
                            childTop = paddingTop;
                            paddingTop += child.getMeasuredHeight();
                            break;
                        case C0132R.styleable.Theme_colorControlActivated /*80*/:
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0132R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0132R.styleable.Theme_actionMenuTextAppearance /*22*/:
                return arrowScroll(66);
            case C0132R.styleable.Theme_textColorSearchUrl /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
