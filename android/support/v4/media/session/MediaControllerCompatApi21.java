    ...
    public static class PlaybackInfo {
        ...
        private static int toLegacyStreamType(AudioAttributes aa) {
            ...
            switch (aa.getUsage()) {
                ...
                case C0132R.styleable.Toolbar_titleMargins /*11*/:
                case C0132R.styleable.Toolbar_titleMarginStart /*12*/:
                case C0132R.styleable.Toolbar_titleMarginTop /*14*/:
                    return 3;
                ...
                case STREAM_BLUETOOTH_SCO /*6*/:
                    return 2;
                case C0132R.styleable.Toolbar_titleMarginEnd /*13*/:
                    return 1;
                default:
                    return 3;
            }
